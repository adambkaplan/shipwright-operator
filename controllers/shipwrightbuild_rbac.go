...
// +kubebuilder:rbac:groups=core,resources=namespaces,verbs=create;delete;get;list;patch;update;watch
...
// +kubebuilder:rbac:groups=operator.tekton.dev,resources=tektonconfigs,verbs=create;delete;get;list;patch;update;watch
